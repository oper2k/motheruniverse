...
class CustomPickerWeeks extends StatefulWidget {
  const CustomPickerWeeks({
    Key? key,
  ...
  @override
  State<CustomPickerWeeks> createState() => _CustomPickerWeeksState();
}

class _CustomPickerWeeksState extends State<CustomPickerWeeks> {
  ...
  void _onFirstItemsChanged(int index) {
    setState(() {
      FFAppState().weekPickerIndex1 = index;
    });
    log('First: $index');
  }
