                        ...
                        if (_model.timerStarted) {
                          ...
                          if (dateTimeFormat(
                            ...
                            await TrackersRecord.createDoc(
                              ...
                              breastLeftDuration: _model.timerLeftMilliseconds,
                              breastRightDuration:
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: const ResetBreastTrackerWidget(),
                            ),
                          );
                        },
                      ).then(
                          (value) => safeSetState(() => _model.reset = value));
                          ...
                          if (_model.timerStarted) {
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      FlutterFlowTheme.of(context).yellowLight,
                                  borderRadius: BorderRadius.circular(14.0),
                                ),
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
