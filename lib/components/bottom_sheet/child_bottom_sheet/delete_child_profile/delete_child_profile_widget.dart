...
import 'delete_child_profile_model.dart';
export 'delete_child_profile_model.dart';
...
class _DeleteChildProfileWidgetState extends State<DeleteChildProfileWidget> {
  late DeleteChildProfileModel _model;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                child: Text(
                  'Вы уверены, что хотите безвозвратно удалить профиль ребенка?',
                  textAlign: TextAlign.center,
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    await widget.child!.reference.delete();
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 0.0, 45.0),
