...
import 'reset_feeding_tracker_model.dart';
...
class _ResetFeedingTrackerWidgetState extends State<ResetFeedingTrackerWidget> {
  late ResetFeedingTrackerModel _model;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Вы уверены что хотите сбросить текущий трек прикорма?',
                  textAlign: TextAlign.center,
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    Navigator.pop(context, _model.reset);
                  },
                  child: Container(
                    width: double.infinity,
                    height: 56.0,
