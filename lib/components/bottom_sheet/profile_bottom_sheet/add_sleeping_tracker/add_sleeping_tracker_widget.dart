...
class AddSleepingTrackerWidget extends StatefulWidget {
  const AddSleepingTrackerWidget({
    Key? key,
    required this.child,
  }) : super(key: key);
  ...
  @override
  _AddSleepingTrackerWidgetState createState() =>
      _AddSleepingTrackerWidgetState();
}

class _AddSleepingTrackerWidgetState extends State<AddSleepingTrackerWidget> {
  late AddSleepingTrackerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddSleepingTrackerModel());
