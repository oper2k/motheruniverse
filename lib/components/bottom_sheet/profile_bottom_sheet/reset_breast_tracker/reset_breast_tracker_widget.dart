...
import 'reset_breast_tracker_model.dart';
...
class _ResetBreastTrackerWidgetState extends State<ResetBreastTrackerWidget> {
  late ResetBreastTrackerModel _model;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Вы уверены что хотите сбросить текущий трек груди?',
                  textAlign: TextAlign.center,
