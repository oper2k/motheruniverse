          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Заработайте баллы за публикацию отзыва о приложении в AppStore или GooglePlay, а так же публикацию в соц.сетях\nМожно получить баллы максимум за 5 (Пять) таких обзоров в течение 1 (Одного) календарного года. Во избежание сомнений, Вы праве самостоятельно определить содержание такого обзора, соблюдая при этом правила публикации обзоров',
