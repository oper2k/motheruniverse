...
import 'buying_bonuses_model.dart';
...
class _BuyingBonusesWidgetState extends State<BuyingBonusesWidget> {
  late BuyingBonusesModel _model;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text:
                            'Бонус за покупку образовательных лекций и курсов. Бонусные баллы рассчитываются ',
                        style:
                            FlutterFlowTheme.of(context).headlineSmall.override(
                                  fontFamily: 'Inter',
                                  lineHeight: 1.5,
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 91.0, 0.0, 45.0),
