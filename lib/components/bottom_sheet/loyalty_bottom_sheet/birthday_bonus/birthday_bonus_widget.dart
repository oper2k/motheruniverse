...
import 'birthday_bonus_model.dart';
...
class _BirthdayBonusWidgetState extends State<BirthdayBonusWidget> {
  late BirthdayBonusModel _model;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Получите дополнительные баллы в честь вашего дня рождения. Этот Бонус будет автоматически начислен на Ваш аккаунт. Бонус в честь дня рождения может быть начислен только 1 (Один) раз в течение календарного года.',
