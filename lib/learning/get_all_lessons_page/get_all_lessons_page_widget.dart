...
class _GetAllLessonsPageWidgetState extends State<GetAllLessonsPageWidget> {
  late GetAllLessonsPageModel _model;
                                  ...
                                  children: [
                                                      ...
                                                      ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(0.0),
                                                        child: Image.asset(
                                                          'assets/images/Group_10549.webp',
                                                          height: 46.0,
                                                          fit: BoxFit.cover,
                                                        ),
                                                      ),
                                                      ...
                                                      ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(0.0),
                                                        child: Image.asset(
                                                          'assets/images/Group_10548.webp',
                                                          height: 46.0,
                                                          fit: BoxFit.cover,
                                                        ),
                                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/simple_arrow.webp',
                                          width: 84.0,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ...
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        ...
                                        'lessonsReferences': serializeParam(
                                          allLessonsDocsLearningRecordList
